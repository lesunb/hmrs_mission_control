...
def create_hospital_scenario_map() -> Map:
    ...
    ic_corridor_4 = Nodes("IC Corridor 4",[-37.00, 33.98])
    ic_corridor_5 = Nodes("IC Corridor 5",[-37.00, 33.95])
    ...
    ic_room_4 = Nodes("IC Room 4",[-39.44, 33.98, 0.00])
    ic_room_5 = Nodes("IC Room 5",[-32.88, 33.95, 3.14])
    ic_room_6 = Nodes("IC Room 6",[-33.90, 18.93, 3.14])

    pc_corridor_1 = Nodes("PC Corridor 1",[-27.23, 16.00])
    pc_corridor_2 = Nodes("PC Corridor 2",[-18.00, 16.00])
    pc_corridor_3 = Nodes("PC Corridor 3",[-28.50, 16.00])
    pc_corridor_4 = Nodes("PC Corridor 4",[-27.25, 16.00])
    ...
    pc_room_1 = Nodes("PC Room 1",[-27.23, 13.00, 1.57])
